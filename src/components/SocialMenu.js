...
import { MailIcon, LinkedInIcon, GitHubIcon, InstagramIcon, UpworkIcon } from './Icons';

const SocialMenu = ({ inNav }) => (
    <nav className={`social ${inNav ? 'social__navigation' : ''}`}>
        <ul>
            <li className="social__icon social__icon--mail">
                <a href="mailto:kuzma031@yahoo.com" role="button" aria-label="mail link"><MailIcon /></a>
            </li>
            <li className="social__icon social__icon--linkedin">
                <a href="https://www.linkedin.com/in/djordje-kuzmanovic-447383144/"  role="button" aria-label="linkedin link" target="_blank" rel="noreferrer noopener"><LinkedInIcon /></a>
            </li>
